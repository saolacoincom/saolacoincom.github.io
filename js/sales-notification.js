...
$(window).on('load', function() {
    ...
    setTimeout(function() {
        ...
        $.notify({
            icon: 'images-counter/user-1.png',
            title: 'Byron Morgan From Australia',
            message: 'Recently purchased <span class="blue">2500 SAOLA</span> tokens'
        },{
            type: 'minimalist',
            placement: {
                from: "bottom",
    ...
    setTimeout(function() {
        ...
        $.notify({
            icon: 'images-counter/user-11.png',
            title: 'Peter Lee From Canada',
            message: 'Recently purchased <span class="blue">1850 SAOLA</span> tokens'
        },{
            type: 'minimalist',
            placement: {
                from: "bottom",
